...
describe("Test the Login Component", () => {
  ...
  test("email input field should accept email", () => {
    ...
    userEvent.type(email, "rajesh");
    expect(email.value).not.toMatch("rajesh.gaikwad@gmail.com");
  });
  ...
  test("should be able to submit the form", () => {
    ...
    userEvent.type(email, "rajesh.gaikwad@gmail.com");
    userEvent.type(password, "123456");
    userEvent.click(btnList[0]);

    const user = screen.getByText("rajesh.gaikwad@gmail.com");
